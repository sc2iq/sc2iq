  ...
  return (
    <Form method="post" replace className="border p-5 rounded-xl flex flex-col gap-2 bg-slate-200 border-slate-300">
      ...
      <div className="flex gap-4">
        <label className="flex gap-2 items-center w-28" htmlFor='tags'>Tags:</label>
        <input className="flex-grow p-1 px-2 rounded-md" type="text" autoComplete="off" placeholder='terran, units' id="tags" name="tags" />
      </div>
      <div className="flex gap-4">
        <label className="flex gap-2 items-center w-28" htmlFor='difficultyMin'>Min Difficulty:</label>
      ...
      <div className="flex gap-4">
        <label className="flex gap-2 items-center w-28" htmlFor='difficultyMax'>Max Difficulty:</label>
